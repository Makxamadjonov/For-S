...
document.addEventListener("DOMContentLoaded", () => {
  ...
  startButton.addEventListener("click", () => {
    ...
    audio.play().catch((err) => {
      console.warn("Audio bloklandi:", err);
    });

    // Start oynani yashirish
...
// oxirgi yurak ko'tarilgandan so'ng 2s kutib yozuvni chiqaramiz
setTimeout(function () {
    document.querySelector('.i-love-you').style.opacity = 1;
    document.querySelector('.i-love-you').style.animation = 'fadeInUp 2.5s ease-out forwards';
}, 150000);
